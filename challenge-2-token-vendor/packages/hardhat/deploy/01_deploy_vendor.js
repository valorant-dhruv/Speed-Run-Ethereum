...
module.exports = async ({ getNamedAccounts, deployments }) => {
  ...
  //Hence what happens is that the deployer is the user generated address which deploys both the smart contracts
  //Intially the deployer account address holds all the token balance
  //Now we transfer the tokens to the vendor smart contract
  ...
  //Transferring the ownership to the frontend account address
