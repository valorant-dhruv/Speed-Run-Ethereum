...
//The infura id is used to connect to the ethereum node
//The networks is a javascript object consisting of all the networks that are present
//The network is a function to access specific networks
...
//This is the localprovider that we got access from based on the rpcurl of the infura node
